...
module.exports = {
  ...
  google: function(req, res) {
    passport.authenticate('google', { failureRedirect: '/login', scope: ['profile', 'email','https://www.googleapis.com/auth/drive']  }, function(err, user) {
      if (err) {
        console.log(err);
        req.flash('error', 'Se ha intentado loguear con una cuenta personal');
